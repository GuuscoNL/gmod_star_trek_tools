...
SWEP.CustomViewModel = "models/crazycanadian/startrek/tools/autosuture.mdl"
...
SWEP.healSpeed = 5 -- Health points per second
SWEP.minHeal = .20
SWEP.maxHeal = .75
...
SWEP.BEAM_3RD_START_OFFSET = Vector(7.5, -2.3, -3.8)
